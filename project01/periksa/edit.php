...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    // Query untuk mengambil data pasien berdasarkan ide
                        ...
                        <div class="card-body">
                            ...
                            <form action="edit.php?id=<?= $row['id'] ?>" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="pasien_id" name="pasien_id" type="number" class="form-control" value="<?= $row['pasien_id'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="dokter_id" name="dokter_id" type="number" class="form-control" value="<?= $row['dokter_id'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
